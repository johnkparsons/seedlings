...
total_mod1 <- glmmTMB(total ~ Site*Plot + (1|Block/Transect), data = june18_dat, family = gaussian)
...
simulationOutput <- simulateResiduals(fittedModel = dead_mod, plot = T, n = 1000)
